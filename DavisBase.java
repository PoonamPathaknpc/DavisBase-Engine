...
public class DavisBase {
	...
	public static void init(){
		try {
			File dataDir = new File("data");
			if(dataDir.mkdir()){				
				CommandFunctions.BackgroundFileCreation();
			}else {
	...
	public static void parseUserCommand (String userCommand) {
		...
		switch (commandTokens[0]) {
			...
			case "create":
				...
				CommandFunctions.createTable(create_table, create_cols);		
				break;
			...
			case "drop":
				...
				CommandFunctions.dropTable(tb);
				break;

			case "show":
				CommandFunctions.showTable();
				break;
			...
			case "insert":
				...
				CommandFunctions.insertTable(insert_table, insert_values);
				break;
			...
			case "update":
				...
				CommandFunctions.updateTable(update_table, set, update_cmp);
				break;
			...
			case "select":
				...
				CommandFunctions.selectTable(select_table, select_column, select_cmp);
				break;
